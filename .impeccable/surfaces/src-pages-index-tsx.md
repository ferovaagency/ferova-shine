...
- Primary target: `src/pages/Index.tsx` and the Spanish public shell it composes.
...
- Video and motion require static and reduced-motion fallbacks.

## Chosen direction

Agency Delivery Console: a modular physical routing system where a brief enters, specialist capabilities are activated, and a documented delivery exits through a gold signal rail. Approved delegated comp: `.impeccable/mocks/home-console-a.png`.

The memorable moment is one orchestrated gold signal pulse crossing the console from the agency brief to the delivery port. The implementation must suggest a real object without converting semantic UI into a screenshot.

## Component grammar

- Corners: 8-14px on controls; 20-28px only on major physical housings.
- Lines: 1px muted gold/charcoal seams; no generic gray card grid.
- Elevation: tight contact shadows and inset highlights that read as metal or ceramic; no glass blur.
- Type: geometric Nexa-like sans; condensed/heavy display silhouette for the hero, readable geometric sans for body.
- Controls: activation keys, labeled ports and cartridge tabs rather than pill buttons.
- Responsive rule: preserve copy first, collapse the console to one shallow module rail, keep all content accessible without motion.
...
- The exact English-domain shell will inherit this system after the Spanish surface is verified; English editorial content remains independently authored.
