...
export const HOME: Record<Lang, HomeContent> = {
  es: {
    ...
    hero: {
      ...
      sub: "Entendemos primero tu negocio. Después construimos la estrategia, la tecnología y la inteligencia que realmente necesita para crecer.",
  ...
  en: {
    ...
    hero: {
      ...
      sub: "We understand your business first. Then we build the strategy, technology and intelligence it actually needs to grow.",
  ...
  pt: {
    ...
    hero: {
      ...
      sub: "Entendemos primeiro o seu negócio. Depois construímos a estratégia, a tecnologia e a inteligência que ele realmente precisa para crescer.",
