        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            ...
            <div className="mt-4 space-y-2 text-sm text-muted-foreground">
              ...
              <a href="https://wa.link/bfq71f" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent('whatsapp_button_clicked', { source: 'footer', label: 'phone_link' })} className="flex items-center gap-2 transition-colors hover:text-gold">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {([
                { Icon: MessageCircle, name: 'whatsapp', url: 'https://wa.link/bfq71f' },
