  ...
  const NAV: Record<"es" | "en" | "pt", { primary: NavItem[]; agencyLabel: string; agencyItems: NavItem[] }> = {
    es: {
      ...
      agencyItems: [
        ...
        { label: "Creación de Contenido LinkedIn", href: "/servicios/contenido-linkedin" },
      ],
    },
    en: {
      agencyLabel: "Agency",
      ...
      agencyItems: [
        ...
        { label: "LinkedIn Content Creation", href: "/en/services/linkedin-content" },
      ],
    },
    pt: {
      agencyLabel: "Agência",
      ...
      agencyItems: [
        ...
        { label: "Criação de Conteúdo LinkedIn", href: "/pt/conteudo-linkedin" },
      ],
    },
  };
