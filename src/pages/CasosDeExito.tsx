        ...
        <section className="py-20 md:py-28 bg-surface">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <AnimatedSection>
              ...
              <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }} href="https://wa.link/hbrsxy" target="_blank" rel="noopener noreferrer" className="btn-gold inline-flex items-center gap-2">
