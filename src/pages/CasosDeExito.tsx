...
export const casesData = {
  es: [
    {
      id: 'google-ads-arcos-desinfeccion',
      title: '100 llamadas y 150 mensajes diarios con Google Ads',
      category: 'pauta',
      country: 'Colombia',
      icon: Target,
      ...
      results: [
        { metric: 'Llamadas diarias', value: '100', period: 'promedio' },
        { metric: 'Mensajes WhatsApp', value: '150/día', period: 'clientes interesados' },
        { metric: 'Ingresos mensuales', value: '$225M COP', period: 'promedio' },
        { metric: 'ROI', value: '224x', period: 'la inversión' },
      ],
    },
    {
      id: 'ecommerce-cableado-estructurado',
      title: '15 cotizaciones diarias en e-commerce de cableado',
      category: 'seo',
      country: 'Colombia',
      icon: BarChart3,
      ...
      results: [
        { metric: 'Posiciones #1', value: '50', period: 'referencias' },
        { metric: 'Productos indexados', value: '12.486', period: 'primera página' },
        { metric: 'Cotizaciones diarias', value: '10-15', period: 'constantes' },
        { metric: 'Tasa de cierre', value: '93%', period: 'solicitudes' },
      ],
    },
    {
      id: 'ecommerce-mascotas',
      title: 'Triplicamos ventas en e-commerce de mascotas',
      category: 'seo',
      country: 'Colombia',
      icon: ShoppingCart,
      ...
      results: [
        { metric: 'Ventas mensuales', value: '$3M → $10M', period: '3 meses' },
        { metric: 'Producto #1 Google', value: 'Guabi gato', period: '2 meses' },
        { metric: 'Estabilidad del sitio', value: '100%', period: 'sin caídas' },
        { metric: 'Crecimiento', value: '+233%', period: 'en ventas' },
      ],
    },
  ],
  en: [
    {
      id: 'google-ads-arcos-desinfeccion',
      title: '100 calls & 150 daily WhatsApp messages with Google Ads',
      category: 'pauta',
      country: 'Colombia',
      icon: Target,
      ...
      results: [
        { metric: 'Daily calls', value: '100', period: 'average' },
        { metric: 'WhatsApp messages', value: '150/day', period: 'interested clients' },
        { metric: 'Monthly revenue', value: '$225M COP', period: 'average' },
        { metric: 'ROI', value: '224x', period: 'the investment' },
      ],
    },
    {
      id: 'ecommerce-cableado-estructurado',
      title: '15 daily quotes for a structured cabling e-commerce',
      category: 'seo',
      country: 'Colombia',
      icon: BarChart3,
      ...
      results: [
        { metric: '#1 positions', value: '50', period: 'references' },
        { metric: 'Indexed products', value: '12,486', period: 'first page' },
        { metric: 'Daily quotes', value: '10-15', period: 'consistent' },
        { metric: 'Close rate', value: '93%', period: 'requests' },
      ],
    },
    {
      id: 'ecommerce-mascotas',
      title: 'Tripled sales for a pet e-commerce',
      category: 'seo',
      country: 'Colombia',
      icon: ShoppingCart,
      ...
      results: [
        { metric: 'Monthly sales', value: '$3M → $10M', period: '3 months' },
        { metric: '#1 on Google', value: 'Guabi cat', period: '2 months' },
        { metric: 'Site stability', value: '100%', period: 'no downtime' },
        { metric: 'Growth', value: '+233%', period: 'in sales' },
      ],
    },
  ],
};
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <AnimatedSection>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mb-6">
                {lang === 'es' ? 'Casos de Éxito Reales' : 'Real Case Studies'}
              </h1>
            </AnimatedSection>
            <AnimatedSection delay={0.1}>
              <p className="text-muted-foreground text-lg max-w-xl mx-auto">
                {lang === 'es' ? 'Resultados comprobables de nuestros clientes en Colombia.' : 'Proven results from our clients in Colombia.'}
              </p>
            </AnimatedSection>
          </div>
        </section>
                    ...
                    <ScaleOnHover>
                      <Link to={`${basePath}/${c.id}`} className="glass-card p-6 hover:border-gold/30 transition-all duration-300 group block h-full">
                        ...
                        <span className="inline-flex items-center gap-1 text-gold text-sm font-medium group-hover:gap-2 transition-all">
                          {lang === 'es' ? 'Ver caso completo' : 'View full case'} <ArrowRight className="w-4 h-4" />
                        </span>
                      </Link>
                    </ScaleOnHover>
                  </StaggerItem>
