...
const Index = ({ lang = 'es' }: IndexProps) => {
  ...
  const t = lang === 'es' ? {
    ...
    heroSub: 'Construimos webapps de alto rendimiento para e-commerce en Colombia, Latam y USA. Entrega en 1 semana. Sin código. Con resultados.',
    ...
    compSub: 'En Ferova Agency construimos webapps en Lovable + React + Supabase con IA integrada. Tu cliente pregunta, la IA responde y convierte. Tú recibes el pedido.',
    ...
    diffTitle: 'Lo que los clientes preguntan — y lo que respondemos',
    diffSub: 'Formato They Ask, You Answer: respondemos con transparencia las preguntas que todos tienen.',
    differentiators: [
      { icon: Target, title: '¿Cuánto cuesta realmente?', desc: 'Desde $599 USD una web profesional. Desde $199 USD/mes un plan SEO completo. Sin costos ocultos.' },
      { icon: Lightbulb, title: '¿Por qué no WordPress?', desc: 'WordPress requiere plugins, mantenimiento y es lento. Nuestras webapps son 5x más rápidas y seguras.' },
    ...
    heroSub: 'Construímos webapps de alto desempenho para e-commerce na Colômbia, Latam e EUA. Entrega em 1 semana. Sem código. Com resultados.',
    ...
    compSub: 'Na Ferova Agency construímos webapps em Lovable + React + Supabase com IA integrada. Seu cliente pergunta, a IA responde e converte. Você recebe o pedido.',
    ...
    diffTitle: 'O que os clientes perguntam — e o que respondemos',
    diffSub: 'Formato They Ask, You Answer: respondemos com transparência as perguntas que todos têm.',
    differentiators: [
      { icon: Target, title: 'Quanto custa realmente?', desc: 'A partir de $599 USD um site profissional. A partir de $199 USD/mês um plano SEO completo. Sem custos ocultos.' },
      { icon: Lightbulb, title: 'Por que não WordPress?', desc: 'WordPress requer plugins, manutenção e é lento. Nossas webapps são 5x mais rápidas e seguras.' },
    ...
    heroSub: 'We build high-performance webapps for e-commerce in Colombia, Latam and the US. 1-week delivery. No code. Real results.',
    ...
    compSub: 'At Ferova Agency we build webapps on Lovable + React + Supabase with integrated AI. Your customer asks, the AI answers and converts. You get the order.',
    ...
    diffTitle: 'What clients ask — and what we answer',
    diffSub: 'They Ask, You Answer format: we respond with transparency to the questions everyone has.',
    differentiators: [
      { icon: Target, title: 'How much does it really cost?', desc: 'From $599 USD a professional website. From $199 USD/mo a full SEO plan. No hidden costs.' },
      { icon: Lightbulb, title: 'Why not WordPress?', desc: 'WordPress requires plugins, maintenance and is slow. Our webapps are 5x faster and more secure.' },
