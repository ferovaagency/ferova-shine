  ...
  return (
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <main className="pt-20">
        <section className="relative overflow-hidden bg-[#071a2f] py-20 text-white md:py-28">
          <div className="absolute -right-24 top-0 h-80 w-80 rounded-full bg-blue-600/20 blur-3xl" />
          <div className="container relative mx-auto max-w-6xl px-4 md:px-6">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-cyan-300">SEO para ecommerce</p>
        ...
        <section className="bg-[#071a2f] py-20 text-center text-white"><div className="container mx-auto px-4 md:px-6"><h2 className="mx-auto max-w-3xl font-display text-3xl font-bold md:text-5xl">Empecemos por identificar qué está frenando el crecimiento.</h2><Link to="/contacto" className="seo-primary-button mt-9">Evaluar mi ecommerce <ArrowRight className="h-4 w-4" /></Link></div></section>
      </main><Footer lang="es" />
    </div>
  );
}
