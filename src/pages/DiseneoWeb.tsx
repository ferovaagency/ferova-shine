...
const DiseneoWeb = ({ lang = 'es' }: Props) => {
  ...
  const t = lang === 'es' ? {
    ...
    build: 'construcción',
    features: [
      { icon: Zap, title: 'Entrega en 1 semana', desc: 'Lo que con métodos tradicionales tarda 6 semanas, lo entregamos en 7 días con nuestro proceso optimizado.' },
    ...
    plans: [
      {
        ...
        icon: Globe,
        name: 'Web Económica',
        tagline: 'Sitio web profesional con IA integrada, entrega en 1 semana.',
    ...
    build: 'construção',
    features: [
      { icon: Zap, title: 'Entrega em 1 semana', desc: 'O que com métodos tradicionais leva 6 semanas, entregamos em 7 dias com nosso processo otimizado.' },
    ...
    plans: [
      {
        ...
        icon: Globe,
        name: 'Web Econômica',
        tagline: 'Site profissional com IA integrada, entrega em 1 semana.',
        priceLabel: { usd: 599, cop: 1800000, brl: 2990 },
        billingType: 'yearly' as const,
        monthlyPrice: null,
        popular: false,
    ...
    build: 'build',
    features: [
      { icon: Zap, title: '1-week delivery', desc: 'What takes 6 weeks with traditional methods, we deliver in 7 days with our optimized process.' },
    ...
    plans: [
      {
        ...
        icon: Globe,
        name: 'Starter Web',
        tagline: 'Professional website with integrated AI, delivered in 1 week.',
        priceLabel: { usd: 599, cop: 1800000, brl: 2990 },
        billingType: 'yearly' as const,
        monthlyPrice: null,
        popular: false,
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "description": "Construimos webapps de e-commerce con tecnología de vanguardia e IA integrada. Entrega en 1 semana. Incluye panel admin, asesor IA de ventas y SEO técnico.",
      ...
      <main className="pt-20">
        ...
        <section className="py-20 md:py-28 text-center relative grid-pattern">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <a href="https://wa.link/jvbd4j?text=Hola%20Ferova%2C%20quiero%20información%20sobre%20diseño%20web" target="_blank" rel="noopener noreferrer" className="btn-gold inline-flex items-center gap-2">
        ...
        <section className="py-20 md:py-28 text-center">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <a href="https://wa.link/jvbd4j?text=Hola%20Ferova%2C%20quiero%20una%20propuesta%20de%20diseño%20web" target="_blank" rel="noopener noreferrer" className="btn-gold inline-flex items-center gap-2">
              <MessageCircle className="w-5 h-5" />
