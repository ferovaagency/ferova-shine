...
const SobreMariaFer = ({ lang = "es" }: SobreMariaFerProps) => {
  ...
  const content = {
    es: {
      ...
      hero: {
        ...
        bullets: ["6+ años liderando marketing digital", "SEO para Ecommerce", "Sitios en WordPress"],
      ...
      about: {
        title: "Sobre mí",
        description:
          "Profesional en marketing y estrategia comercial. 6 años dirigiendo equipos de marketing digital y proyectos SEO. Me enfoco en crear experiencias web útiles y agradables para las personas y en que cada acción sea clara y medible. Trabajo contigo como aliada estratégica, no solo como proveedora.",
        values: [
    ...
    en: {
      ...
      hero: {
        ...
        bullets: ["6+ years leading digital marketing", "Ecommerce SEO", "WordPress Sites"],
      ...
      about: {
        title: "About me",
        description:
          "Marketing and commercial strategy professional. 6 years leading digital marketing teams and SEO projects. I focus on creating useful and enjoyable web experiences for people and ensuring that every action is clear and measurable. I work with you as a strategic partner, not just a provider.",
        values: [
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Nexa', 'Inter', sans-serif" }}>
      ...
      <title>
        {lang === "es"
          ? "Maria Fer Calderón – Autora y contacto | Ferova Agency"
          : "Maria Fer Calderón – Author and contact | Ferova Agency"}
      </title>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center gap-8">
              <button
                ...
                className="text-neutral-700 hover:text-[#541014] transition-colors"
              >
                {t.nav.inicio}
              </button>
              <button
          ...
          {mobileMenuOpen && (
            <nav className="lg:hidden py-4 border-t border-neutral-200">
              <div className="flex flex-col gap-4">
                <button
                  onClick={() => scrollToSection("inicio")}
                  className="text-left text-neutral-700 hover:text-[#541014] py-2"
                >
                  {t.nav.inicio}
                </button>
                <button
      ...
      <section id="inicio" className="pt-24 md:pt-32 pb-12 md:pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-8 md:hidden">
            <div
              className="w-48 h-48 rounded-2xl overflow-hidden border-4 shadow-xl"
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start md:items-center">
            ...
            <div>
              <h1
                className="text-3xl md:text-5xl lg:text-6xl font-bold mb-3 md:mb-4 text-center md:text-left"
                style={{ color: "#541014" }}
              >
                {t.hero.name}
              </h1>
            ...
            <div className="hidden md:flex justify-center">
              <div
                className="w-full max-w-md aspect-square rounded-2xl overflow-hidden border-4 shadow-xl"
                style={{ borderColor: "#C0930E" }}
              >
                <img
                  src="/img/maria-fer.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12">
            {t.services.items.map((service, index) => (
              <Card
                key={index}
                className="rounded-xl md:rounded-2xl border-neutral-200 shadow-sm hover:shadow-lg transition-shadow"
              >
      ...
      <section id="anuncios" className="py-12 md:py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-6">
            <p className="text-xs md:text-sm text-neutral-500 mb-1">{t.banners.note}</p>
          </div>
              ...
              <div className="aspect-[16/5] md:aspect-[4/1] bg-gradient-to-br from-neutral-100 to-neutral-50 flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <p className="text-xs md:text-sm text-neutral-500">
                    {lang === "es" ? "Espacio publicitario" : "Ad space"}
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "#2F2D56" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-12 text-center text-white">{t.results.title}</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12">
            {t.blog.posts.map((post, index) => (
              <Card
                key={index}
                className="rounded-xl md:rounded-2xl border-neutral-200 shadow-sm hover:shadow-lg transition-shadow overflow-hidden"
              >
                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <p className="text-sm md:text-base text-neutral-700 leading-relaxed">{post.excerpt}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section id="contacto" className="py-12 md:py-20" style={{ backgroundColor: "#541014" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-12 text-center text-white">{t.contact.title}</h2>

          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Quick Links Column */}
            <div>
              <h3 className="text-xl font-bold mb-6 md:mb-8 text-white">{t.contact.quickLinks.title}</h3>
