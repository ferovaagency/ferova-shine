          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="glass-card p-8 gold-glow relative" style={{ borderColor: 'hsl(45 86% 40%)' }}>
                ...
                <a href={`https://wa.link/hbrsxy?text=${encodeURIComponent(proWaMsg[currency])}`} target="_blank" rel="noopener noreferrer" onClick={() => trackNewsletter('subscribe_paid', 'pro')} className="btn-gold w-full block text-center">
