...
const Soluciones = ({ lang = 'es' }: SolucionesProps) => {
  ...
  const problems: Problem[] = lang === 'es' ? [
    ...
    { key: 'diagnostico', icon: Compass, problem: 'No sabemos qué necesita la empresa', detail: 'Sientes que algo no funciona, pero no tienes claro cuál es el problema de fondo a resolver primero.', href: '/consultoria-estrategica', cta: 'Empezar por un diagnóstico' },
  ] : lang === 'pt' ? [
    ...
    { key: 'diagnostico', icon: Compass, problem: 'Não sabemos do que a empresa precisa', detail: 'Você sente que algo não funciona, mas não tem claro qual é o problema de fundo a resolver primeiro.', href: '/pt/consultoria-estrategica', cta: 'Começar por um diagnóstico' },
  ] : [
    ...
    { key: 'diagnostico', icon: Compass, problem: "We don't know what the business needs", detail: 'You feel something is off, but you\'re not sure what the underlying problem to solve first is.', href: '/en/strategy-advisory', cta: 'Start with a diagnosis' },
  ];
