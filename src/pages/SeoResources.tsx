...
const collections = [
  ...
  { icon: Bot, title: "Búsqueda con IA", text: "Entidades, contenido citable, datos estructurados y medición.", href: "/recursos/evaluador-preparacion-ai-search" },
