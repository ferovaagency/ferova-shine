...
drop policy if exists "site editors insert newsletter editions" on public.newsletter_editions;
drop policy if exists "site editors update newsletter editions" on public.newsletter_editions;
drop policy if exists "site owners delete newsletter editions" on public.newsletter_editions;
